...
void calcola_lista_medie(tree *t, list *&);
void calcola_lista_medie_aux(tree *t, list *&, int s, int c);
...
void calcola_lista_medie(tree *t, list *&l){
  ...
  if(t==nullptr)
    return;
  return calcola_lista_medie_aux(t,l,0,0);
}
void calcola_lista_medie_aux(tree *t, list *&l, int s, int c){
  if(t==nullptr)
    return;
  if((t->info%2)==0){
    s+=t->info;
  ...
  if(t->left==nullptr && t->right==nullptr){
    l=new list{(double)s/c, l};
    return;
  }
  if(t->left== nullptr){
    l=new list{(double)s/c, l};
    calcola_lista_medie_aux(t->right,l,s,c);
    return;
  }else if(t->right == nullptr){
    l=new list{(double)s/c, l};
    calcola_lista_medie_aux(t->left,l,s,c);
    return;
  }
  calcola_lista_medie_aux(t->left,l,s,c);
  calcola_lista_medie_aux(t->right,l,s,c);
